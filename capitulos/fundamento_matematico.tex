...
\begin{definicion}
    ...
    \begin{center}
        \begin{tikzcd}[row sep=1cm, column sep=1cm]
            &  P \arrow{ld}[swap]{\pi_{1}} \arrow{rd}{\pi_{2}} & \\
            X & & Y
        \end{tikzcd}
    \end{center}
    ...
    \begin{figure}[htpb]
        \centering
        \begin{tikzcd}[row sep=1cm, column sep=1cm]
            &  A \arrow{ld}[swap]{\f_{X}} \arrow{rd}{\f_{Y}} & \\
            X & & Y
        \end{tikzcd}
        \caption{Producto}
        \label{diag:producto}
    ...
    \begin{figure}[htpb]
        \centering
        \begin{tikzcd}[row sep=1cm, column sep=1cm]
            & A \arrow[dashed]{d}[description]{\exists! \ \bar{f}} \arrow{ld}[swap]{f_1} \arrow{rd}{f_2} & \\
            X & P \arrow{l}[swap]{\pi_{1}} \arrow{r}{\pi_{2}} & Y
        \end{tikzcd}
