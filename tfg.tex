...
\newcommand{\miTitulo}{Análisis Topológico de Datos para la estimación de métricas de similitud en algoritmos de Machine Learning\xspace}
\newcommand{\miNombre}{Alberto Díaz Cencillo\xspace}
...
\newcommand{\miTutor}{
  Jesus García Miranda \\ \emph{Departamento de Álgebra} 
...
\input{capitulos/fundamento_matematico}
